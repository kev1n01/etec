		...
		<div class="section">
			<div class="container">
				<div class="col-md-4">
					...
					<h3 class="title"><?php if($ActionType == "Register"){echo "Registrarse";}else echo "Editar tu Cuenta"; ?></h3>
					</div>

					<form action="registroDestination.php?ActionType=<?php echo $ActionType; if($ActionType == "Edit"){ echo "&ID=" .$ID;} ?>" method="post">
						...
						<div class="form-group">
						<input class="input" type="text" class="form-control" name="Nombres" id="Nombres" placeholder="Nombres" required>
						</div>

						<div class="form-group">
						<input class="input" type="text" class="form-control" name="Apellidos" id="Apellidos" placeholder="Apellidos" required>
						</div>

						<div class="form-group">
						<input class="input" type="text" class="form-control" name="Dni" id="Dni" placeholder="Dni" required>
						</div>

						<div class="form-group">
						<input class="input" type="email" class="form-control" name="Email" id="Email" placeholder="Email" required>
						</div>

						<div class="form-group">
						<input class="input" type="tel" class="form-control" name="Celular" id="Celular" placeholder="Celular" required>
						</div>
						
						<button class="primary-btn order-submit" type="submit" >Registrar</button>
					</form>	
				</div>
			</div>
		</div>
