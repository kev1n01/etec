				...
				<div class="col-md-4 col-xs-6">
					<div class="shop">
						...
						<div class="shop-body">
							...
							<a href="store.php" class="cta-btn">Comprar ahora<i class="fa fa-arrow-circle-right"></i></a>
						</div>
					</div>
				</div>
				<!-- /shop -->
					...
					<div class="section-title">
						...
						<div class="section-nav">
							<ul class="section-tab-nav tab-nav">
								<li class="active"><a data-toggle="tab" href="Laptops.php">Laptops</a></li>
								<li><a data-toggle="tab" href="Smartphones.php">Smartphones</a></li>
								<li><a data-toggle="tab" href="Camaras.php">Camaras</a></li>
								<li><a data-toggle="tab" href="Accesorios.php">Accesorios</a></li>
							</ul>
						</div>
					</div>
				</div>
							...
							<div id="tab1" class="tab-pane active">
								<div class="products-slick" data-nav="#slick-nav-1">
									...
									while ($Rows = mysqli_fetch_array($Resulta)) :; ?>
										...
										<div class="product">
											<a href="product.php?ID=<?php echo $Rows[0] . "&Cat=" . $Rows[7] . "&Mar=" . $Rows[6]; ?>">
												<div class="product-img">
													<img src="img/<?php echo $Rows[5]; ?>" alt="img">
											...
											<div class="product-body">
												...
												<h3 class="product-name"><a href="product.php?ID=<?php echo $Rows[0] . "&Cat=" . $Rows[7] . "&Mar=" . $Rows[6]; ?>"><?php echo $Rows[6]; ?></a></h3>
											...
											<form action="agregarCarrito.php" method="post">
												<input type="hidden" name="id_cliente" value="<?php if ($ID == null) {
																									echo "null";
																								} else {
																									echo $ID;
																								} ?>">
					...
					<div class="section-title">
						...
						<div class="section-nav">
							<ul class="section-tab-nav tab-nav">
								...
								<li><a data-toggle="tab" href="#tab3">Camaras</a></li>
								<li><a data-toggle="tab" href="#tab4">Accesorios</a></li>
							</ul>
						</div>
					</div>
				</div>
